		...
		if(is_user_logged_in() && !isset($_POST['profileSubmit']))
		{
			...
			?>
				<form class="createForm" action="<?php $_SERVER['REQUEST_URI']; ?>" method="POST" enctype="multipart/form-data">
					<h2  class="normalize-text">Naam</h2>
					...
					<h2  class="normalize-text">Wachtwoord</h2>
					...
					<h2 class="normalize-text">Contactinformatie</h2>
					...
					<h2  class="normalize-text">Extra informatie</h2>
					<div class="center-radio">
				        ...
				        <input class="radio" <?php if($sex == 'Vrouw') echo 'checked'; ?> type="radio" name="profileSex" id="profileSexWoman" value="Vrouw" /><label for="profileSexWoman">Vrouw</label>
				    </div>
					<section class="form-line center">
