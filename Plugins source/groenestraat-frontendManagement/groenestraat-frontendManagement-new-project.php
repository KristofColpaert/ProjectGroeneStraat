<?php
	...
	*/
	...
	function show_new_project_form()
	{
		...
		{
			?>
				<p class="error-message">U bent niet ingelogd of u hebt de rechten niet om deze pagina te bekijken. <a class="normalize-text" href="<?php echo home_url(); ?>/login">Aanmelden</a></p>
			<?php
		}
	}
