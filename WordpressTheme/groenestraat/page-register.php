...
<script>
    ...
    var firstName = new LiveValidation('first_name', {wait:100,validMessage:"Thank you come again!"});
    ...
    var lastName = new LiveValidation('last_name', {wait:100});
    ...
    var email = new LiveValidation('user_email', {wait:100});
    email.add(Validate.Presence,{failureMessage:nietLeeg});
    email.add(Validate.Length, {maximum:30, tooLongMessage: "Maximum 30 tekens lang!"});
    email.add(Validate.Email, {failureMessage: "Moet een geldig emailadres zijn!"});
    
    var straat = new LiveValidation('rpr_straat', {wait:100});
    straat.add(Validate.Length, {maximum:30, tooLongMessage: "Maximum 30 tekens lang!"});
    
    var gemeente = new LiveValidation('rpr_gemeente', {wait:100});
    gemeente.add(Validate.Length, {maximum:20, tooLongMessage: "Maximum 20 tekens lang!"});
    
    var postcode = new LiveValidation('rpr_postcode', {wait:100});
    ...
    var telefoon = new LiveValidation('rpr_telefoon', {wait:100});
    ...
    var w1 = new LiveValidation('pass1', {wait:100});
    ...
    var w2 = new LiveValidation('pass2', {wait:100});
    ...
    var voorwaarden = new LiveValidation('accept_privacy_policy', {wait:100});
