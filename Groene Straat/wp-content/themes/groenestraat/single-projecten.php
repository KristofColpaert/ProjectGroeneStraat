...
?>
	...
	<section class="container" style="background-color:#ccc">
		...
		<section class="main" data="singleProjecten;1;<?php echo $post->ID; ?>">
		...
		?>
                            ...
                            <section class="list-item normalize-text <?php echo $post->post_type;?>">
                                ...
                                <section class="event-content">
                                    ...
                                    <p><strong>Meer info: </strong><?php echo the_excerpt(); ?></p>
		...
		<?php
					...
					<p>
	                    ...
	                    <?php 
	                        ...
	                        {
	                            ?>
	                                <a style="color:black;" class="author-name" href="<?php echo home_url(); ?>/artikels?zoekveld=&zoeken=zoeken&categorie%5B%5D=<?php echo $category->term_id; ?>"><?php echo $category->name; ?></a> 
	                            <?php
	                        } 
	                    ?>
	                </p>
